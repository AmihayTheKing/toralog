...
double getAdaptiveHeight(BuildContext context, double height) {
  final ratio = MediaQuery.of(context).size.height / 780;
  return height * ratio;
}

double getAdaptiveWidth(BuildContext context, double width) {
  final ratio = MediaQuery.of(context).size.width / 360;
  return width * ratio;
}

HebrewDatePickerTheme getHebrewDatePickerTheme(BuildContext context) {
